...
#                                                                            
# Adapted from original RP-125-14 constraints file:                           
...
#### Expansion connector
set_property IOSTANDARD LVCMOS33 [get_ports {dig_io_*[*]}]
set_property SLEW       FAST     [get_ports {dig_io_*[*]}]
set_property DRIVE      8        [get_ports {dig_io_*[*]}]
set_property PULLUP   TRUE [get_ports {dig_io_*[*]}]

#exp_p_io[0], exp_n_io[0], exp_p_io[1], exp_n_io[1]
set_property PACKAGE_PIN G17 [get_ports {dig_io_1[0]}] 
set_property PACKAGE_PIN G18 [get_ports {dig_io_1[1]}] 
set_property PACKAGE_PIN H16 [get_ports {dig_io_1[2]}] 
set_property PACKAGE_PIN H17 [get_ports {dig_io_1[3]}] 

#exp_p_io[2], exp_n_io[2], exp_p_io[3], exp_n_io[3]
set_property PACKAGE_PIN J18 [get_ports {dig_io_2[0]}] 
set_property PACKAGE_PIN H18 [get_ports {dig_io_2[1]}] 
set_property PACKAGE_PIN K17 [get_ports {dig_io_2[2]}] 
set_property PACKAGE_PIN K18 [get_ports {dig_io_2[3]}] 

#exp_p_io[4], exp_n_io[4], exp_p_io[5], exp_n_io[5]
set_property PACKAGE_PIN L14 [get_ports {dig_io_3[0]}] 
set_property PACKAGE_PIN L15 [get_ports {dig_io_3[1]}] 
set_property PACKAGE_PIN L16 [get_ports {dig_io_3[2]}] 
set_property PACKAGE_PIN L17 [get_ports {dig_io_3[3]}]

#exp_p_io[6], exp_n_io[6], exp_p_io[7], exp_n_io[7]
set_property PACKAGE_PIN K16 [get_ports {dig_io_4[0]}] 
set_property PACKAGE_PIN J16 [get_ports {dig_io_4[1]}] 
set_property PACKAGE_PIN M14 [get_ports {dig_io_4[2]}]
set_property PACKAGE_PIN M15 [get_ports {dig_io_4[3]}] 
